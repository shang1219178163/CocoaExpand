#
# Be sure to run `pod lib lint CocoaExpand.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/shang1219178163@gmail.com/CocoaExpand.git', :tag => s.version.to_s }
